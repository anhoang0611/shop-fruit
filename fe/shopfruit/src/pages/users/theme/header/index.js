    ...
    <>
      <div
        className={`humberger-menu-overlay ${
          isShowHumbergerMenu ? "active" : ""
        }`}
        onClick={() => {
          setIsShowHumbergerMenu(false);
        }}
      ></div>
      <div
        className={`humberger-menu-wrapper ${
          isShowHumbergerMenu ? "show" : ""
        }`}
      >
              ...
              return (
                <li key={menuKey} to={menuItem.path}>
                  ...
                  {menuItem.child && menuItem.isShowSubmenu && (
                    <ul
                      className={`header-menu-dropdown-tablet ${
                        menuItem.isShowSubmenu ? "show-submenu" : ""
                      }`}
                    >
          ...
          <div className="row">
            <div className="col-6 header_top_left">
              <ul>
                ...
                <li>Miễn phí đơn từ {formatter(1000000)}</li>
              </ul>
            </div>
        ...
        <div className="row">
          ...
          <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12">
            ...
            <div className="hamberger-menu">
              <AiOutlineMenu
                onClick={() => {
                  setIsShowHumbergerMenu(!isShowHumbergerMenu);
                }}
              />
            </div>
          </div>
      ...
      <div className="container">
        <div className="row categories-container">
          {/* Responsive menu */}
          <div className="col-lg-3 col-sm-12 categories">
            <div
          ...
          <div className="col-lg-9 col-sm-12 search-container">
